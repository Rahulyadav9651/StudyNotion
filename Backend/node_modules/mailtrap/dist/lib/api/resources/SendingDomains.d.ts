...
import { CreateSendingDomainParams, SendingDomain, SendingDomainsResponse, UpdateSendingDomainParams } from "../../../types/api/sending-domains";
export default class SendingDomainsApi {
     ...
     */
    update(id: number, params: UpdateSendingDomainParams): Promise<SendingDomain>;
    /**
